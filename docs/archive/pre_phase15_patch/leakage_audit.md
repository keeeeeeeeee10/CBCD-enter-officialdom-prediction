...
- **Level 3 — Safer background:** basic personal, family, and pre-entry geographic attributes, still subject to recording bias and temporal checks.
...
| BIOG_MAIN | gender / birth year / index year / dynasty | 3 | Basic person attributes are available as background, subject to missingness and recording bias. | True | True |
